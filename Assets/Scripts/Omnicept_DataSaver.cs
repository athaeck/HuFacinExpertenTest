...
public class Omnicept_DataSaver : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        TimeController.Instance.InCreaseTimeSinceStartet((int)Mathf.Floor(Time.deltaTime * 1000));
    }
    ...
    public void HeartRateHandler(HeartRate hr)
    {
        ...
        {
            HeartRateData.Add(new HRDataEntry(DateTime.Now, TimeController.Instance.GetTimeSinceStart(), hr.Rate));
            Debug.Log(hr);
        }
    }
    ...
    public void HeartRateVariabilityHandler(HeartRateVariability hrv)
    {
        ...
        {
            HeartRateVariabilityData.Add(new HRVDataEntry(DateTime.Now, TimeController.Instance.GetTimeSinceStart(), hrv.Sdnn, hrv.Rmssd));
            Debug.Log(hrv);
        }
    }
    ...
    public void CognitiveLoadHandler(CognitiveLoad cl)
    {
        ...
        {
            CognitiveLoadData.Add(new CLDataEntry(DateTime.Now, TimeController.Instance.GetTimeSinceStart(), cl.CognitiveLoadValue, cl.StandardDeviation, cl.DataState));
            Debug.Log(cl);
        }
    }
    ...
    public void EyeTrackingHandler(EyeTracking et)
    {
        if (saveEyeTracking && et != null)
        {
            ...
            EyeTrackingData.Add(new ETDataEntry(DateTime.Now, TimeController.Instance.GetTimeSinceStart(), cg, et.CombinedGaze.Confidence, LeftEye, RightEye));
            //Debug.Log(et);
        }
    }
